...
export function AboutUs() {
    ...
    `}</script>
                ...
                <div>
                    <div>
                        <img src={accueil} alt="" />
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam aliquid adipisci consequatur, <br /> qui sed, minus commodi numquam magni accusantium laboriosam assumenda! Praesentium sequi ab, reprehenderit cumque dicta perspiciatis fuga earum?</p>
                    </div>
                    <div>
                        <img src="{accueil}" alt="" />
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A quae ullam delectus beatae soluta, vel, consequuntur laudantium praesentium provident <br /> recusandae aliquam minima nesciunt! Deleniti consequuntur impedit rerum itaque harum ea?</p>
                    </div>
                    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
                            <FontAwesomeIcon icon={faFacebook} size="2x" />FACEBOOK </a>
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
                            <FontAwesomeIcon icon={faFacebook} size="2x" />LOGO</a>
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
                            <FontAwesomeIcon icon={faFacebook} size="2x" />FACEBOOK1</a>
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
                            <FontAwesomeIcon icon={faTwitter} size="2x" />TWITTER</a>
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500">
                            <FontAwesomeIcon icon={faInstagram} size="2x" />INSTAGRAM</a>
                    </div>
